...
name: fastapi
description: >-
 Use this skill whenever building, modifying, or testing Python backend APIs, FastAPI routes (APIRouter), async SQLAlchemy 2.0 ORM models, Alembic database migrations, Pydantic v2 validation schemas, dependency injection, async WebSockets, Celery Redis background tasks, or pytest-asyncio test suites.
---
...
- **Async & Pydantic v2**: [async-pydantic-v2.md](./references/async-pydantic-v2.md)
...
- **Authorization & RBAC Permissions**: [authorization-and-rbac.md](./references/authorization-and-rbac.md)
