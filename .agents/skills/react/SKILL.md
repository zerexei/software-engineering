---
name: react
description: "React 19+ functional components, custom hooks, React Router v8+, Shadcn UI, and Vitest guidelines."
---
...
- ⚛️ **Functional Components**: [functional-components.md](./references/functional-components.md)
...
- 🗺️ **React Router v8+**: [react-router.md](./references/react-router.md)
- 🛡️ **Navigation & Guards**: [navigation-and-guards.md](./references/navigation-and-guards.md)
