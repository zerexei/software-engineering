...
- **Zero Decorative Emojis**: Never use emojis (`✨`, `🚀`, `🎉`) in button labels. Use clean Lucide SVG icons with `w-3.5 h-3.5`.
...
- ❌ **Gratuitous Emojis**: Inserting decorative emojis like `🚀 Submit` or `✨ Generate`. Use Lucide icons instead.
