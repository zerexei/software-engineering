...
# Config
PROMPT_FILE="${PROMPT_FILE:-04_ai/workflows/prompts/security-review.md}"
...
echo "Executing Security Review Agent..."
...
if [ -f "$SUCCESS_FILE" ]; then
    echo "Agent completed security review successfully."
else
