...
- 🔐 **Authorization Policies**: [authorization.md](./references/authorization.md)
- 🔑 **Sanctum Authentication**: [authentication.md](./references/authentication.md)
- 🎫 **Sanctum Tokens**: [sanctum-tokens.md](./references/sanctum-tokens.md)
- 🛡️ **RBAC Permissions**: [rbac-permissions.md](./references/rbac-permissions.md)
